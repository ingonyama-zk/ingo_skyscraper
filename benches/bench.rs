...
fn benchmark(c: &mut Criterion) {
    ...
    // c.bench_function("mul_cios_opt_unr_2", |b| b.iter(|| mul_cios_opt_unr_2(black_box(x), black_box(y))));
    // c.bench_function("mul_logjumps_unr_1", |b| b.iter(|| mul_logjumps_unr_1(black_box(x), black_box(y))));
    // c.bench_function("mul_cios_opt_unr_3", |b| b.iter(|| mul_cios_opt_unr_3(black_box(x), black_box(y))));
    // c.bench_function("sqr_cios_opt_unr_3", |b| b.iter(|| sqr_cios_opt_unr_3(black_box(x))));
    // c.bench_function("mul_logjumps_unr_2", |b| b.iter(|| mul_logjumps_unr_2(black_box(x), black_box(y))));
    // c.bench_function("sqr_logjumps_unr_2", |b| b.iter(|| sqr_logjumps_unr_2(black_box(x))));
    ...
    c.bench_function("compress_cios_opt_1", |b| b.iter(|| compress_cios_opt_1(black_box(x), black_box(y))));
    c.bench_function("compress_logjumps_1", |b| b.iter(|| compress_logjumps_1(black_box(x), black_box(y))));
    c.bench_function("compress_logjumps_2", |b| b.iter(|| compress_logjumps_2(black_box(x), black_box(y))));
}
