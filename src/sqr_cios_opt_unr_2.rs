// unrolled ver2 acar cios with 2 temp registers car1, car2
use crate::constants::*;
...
pub fn sqr_cios_opt_unr_2(a: [u64; 4]) -> [u64; 4] {
    ...
    // step 1, 0 - pre
    let tmp = a01.wrapping_add(res0 as u128);
    let res0 = tmp as u64;
    let car2 = (tmp >> 64) as u64;
    // step 1, 1 - pre
    let tmp = a11.wrapping_add(res1 as u128).wrapping_add(car2 as u128);
    let res1 = tmp as u64;
    let car2 = (tmp >> 64) as u64;
    // step 1, 2 - pre
    let tmp = a12.wrapping_add(res2 as u128).wrapping_add(car2 as u128);
    let res2 = tmp as u64;
    let car2 = (tmp >> 64) as u64;
    // step 1, 3 - pre
    ...
    let car2 = (tmp >> 64) as u64;
    // step 2, 1 - pre
    let tmp = a12.wrapping_add(res1 as u128).wrapping_add(car2 as u128);
    let res1 = tmp as u64;
    let car2 = (tmp >> 64) as u64;
    // step 2, 2 - pre
    let tmp = a22.wrapping_add(res2 as u128).wrapping_add(car2 as u128);
    let res2 = tmp as u64;
    let car2 = (tmp >> 64) as u64;
    // step 2, 3 - pre
...
#[inline]
pub fn sqr_cios_opt_unr_2_randin(a: [u64; 4]) -> [u64; 4] {
    let a00 = (a[0] as u128).wrapping_mul(a[0] as u128);
    let a01 = (a[0] as u128).wrapping_mul(a[1] as u128);
    let a02 = (a[0] as u128).wrapping_mul(a[2] as u128);
    let a03 = (a[0] as u128).wrapping_mul(a[3] as u128);
...
fn calc_m(res0: u64) -> (u128, u128, u128, u128) {
    let m = res0.wrapping_mul(U64_MU0);
...
// fn wrapping_add_three(m: u128, r: u64, c: u64) -> (u64, u64) {
//     let tmp = m.wrapping_add(r as u128).wrapping_add(c as u128);
